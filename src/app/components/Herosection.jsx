...
const Herosection = () => {
  return (
    <div className="relative py-20 px-4 sm:px-6 lg:px-8 flex justify-center overflow-hidden min-h-[600px]">
      {/* Left Image - Large and flanking */}
      <div className="absolute bottom-0 left-0 sm:-left-9 md:-left-12 lg:-left-16 w-60 sm:w-80 md:w-96 lg:w-[420px] xl:w-[480px] z-[100]">
        <Image
          src="/boy1.png"
      ...
      <div className="absolute bottom-0 right-0 sm:-right-8 md:-right-12 lg:-right-16 w-64 sm:w-80 md:w-96 lg:w-[420px] xl:w-[480px] z-[100]">
        <Image
          src="/girl1.png"
      ...
      <div className="bg-white/80 rounded-3xl shadow-2xl max-w-4xl w-full p-8 sm:p-12 text-center relative z-20 mx-8 sm:mx-12 md:mx-16 lg:mx-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-[#1E3B4B] hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-full transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            Start Free Practice
          </button>
      ...
      {/* Optional: Add a subtle overlay to ensure card readability */}
