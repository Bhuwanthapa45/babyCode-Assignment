    ...
    <footer className="bg-white text-gray-800">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 xl:px-16 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          {/* Social media column */}
          <div>
      <h3 className="text-sm font-semibold mb-6">Find us on social media</h3>
        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">How To Enroll?</a></li>
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">Students Enrolled</a></li>
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">Alumni</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">Collabration Inquires</a></li>
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">Careers at BabyCode</a></li>
              <li><a href="#" className="text-sm hover:text-gray-600 transition-colors">FAQ</a></li>
